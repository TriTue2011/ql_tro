...
const DEFAULT_SETTINGS = [
  ...
  { khoa: 'minio_access_key', giaTri: '', moTa: 'MinIO Access Key', nhom: 'luuTru', laBiMat: false },
  { khoa: 'minio_secret_key', giaTri: '', moTa: 'MinIO Secret Key', nhom: 'luuTru', laBiMat: true },
