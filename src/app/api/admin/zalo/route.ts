    ...
    select: {
      ...
      chuSoHuu: {
        select: {
          ...
          zaloChatId: true, zaloChatIds: true, pendingZaloChatId: true, zaloAccountId: true, zaloBotServerUrl: true, zaloBotUsername: true, zaloBotPassword: true, zaloBotTtl: true, zaloWebhookToken: true, nhanThongBaoZalo: true,
          hoatDongCuoi: true,
