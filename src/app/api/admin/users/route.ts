    ...
    const selectFields = {
      ...
      toaNhaQuanLy: {
        select: {
          ...
          mucDoSuCo: true,
          mucDoZalo: true,
          mucDoZaloMonitor: true,
          mucDoCongViec: true,
          mucDoKho: true,
          mucDoBaoDuong: true,
          mucDoCaiDatHotline: true,
          mucDoCaiDatEmail: true,
        },
      },
    } as const;
    ...
    const result = users.map(u => {
      ...
      const quyenTheoToaNha = Object.fromEntries(
        u.toaNhaQuanLy.map(q => [
          q.toaNha.id,
          {
            mucDoKichHoatTaiKhoan: q.mucDoKichHoatTaiKhoan,
            mucDoHopDong: q.mucDoHopDong,
            mucDoHoaDon: q.mucDoHoaDon,
            mucDoThanhToan: q.mucDoThanhToan,
            mucDoSuCo: q.mucDoSuCo,
            mucDoZalo: q.mucDoZalo,
            mucDoZaloMonitor: q.mucDoZaloMonitor,
            mucDoCongViec: q.mucDoCongViec,
            mucDoKho: q.mucDoKho,
            mucDoBaoDuong: q.mucDoBaoDuong,
            mucDoCaiDatHotline: q.mucDoCaiDatHotline,
            mucDoCaiDatEmail: q.mucDoCaiDatEmail,
          },
        ]),
      );
      return {
        ...
        toaNhaIds,
        quyenTheoToaNha,
        mucDoKichHoatTaiKhoan: managedEntry?.mucDoKichHoatTaiKhoan ?? 'hidden',
        mucDoHopDong: managedEntry?.mucDoHopDong ?? 'hidden',
        mucDoHoaDon: managedEntry?.mucDoHoaDon ?? 'hidden',
        mucDoThanhToan: managedEntry?.mucDoThanhToan ?? 'hidden',
        mucDoSuCo: managedEntry?.mucDoSuCo ?? 'hidden',
        mucDoZalo: managedEntry?.mucDoZalo ?? 'hidden',
        mucDoZaloMonitor: managedEntry?.mucDoZaloMonitor ?? 'hidden',
        mucDoCongViec: managedEntry?.mucDoCongViec ?? 'hidden',
        mucDoKho: managedEntry?.mucDoKho ?? 'hidden',
        mucDoBaoDuong: managedEntry?.mucDoBaoDuong ?? 'hidden',
        mucDoCaiDatHotline: managedEntry?.mucDoCaiDatHotline ?? 'hidden',
        mucDoCaiDatEmail: managedEntry?.mucDoCaiDatEmail ?? 'hidden',
      };
    });
